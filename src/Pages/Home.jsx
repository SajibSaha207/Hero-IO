        ...
        <div>
            ...
            <div className="text-center mt-12">
                ...
                <p className='mt-5 font-light'>
                    At HERO.IO, we craft innovative apps designed to make everyday life simpler, <br />
                ...
                <div className='m-2 p-2 text-xl flex gap-4 justify-center mt-5'>
                    <a href="https://play.google.com/store/games?hl=en" className='btn flex gap-2 items-center'>
                        <FontAwesomeIcon icon={faGooglePlay} /> Google Play
                    </a>

                    <a href="https://www.apple.com/app-store/" className='btn flex gap-2 items-center'>
            ...
            {/* SHOW ALL BUTTON */}
            <Link to="/apps">
                <button className='btn p-5 mt-10 flex mx-auto bg-gradient-to-r from-purple-600 to-purple-400 text-white'>
                    Show All
                </button>
            </Link>
